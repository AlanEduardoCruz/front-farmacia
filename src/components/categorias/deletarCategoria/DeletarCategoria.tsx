...
function DeletarCategoria() {
    ...
    const [exclusaoSucesso, setExclusaoSucesso] = useState<boolean>(false)
    ...
    return (
        <div className='container w-1/3 mx-auto'>
            ...
            {exclusaoSucesso && (
                <p className="text-green-500 text-center font-semibold mb-4">Categoria excluída com sucesso!</p>
            )}
